...
public final class PrivacyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text.setText(
                ...
                + "外部サービスへの送信\n"
                + "歌詞検索のため、曲名・アーティスト名・アルバム名・再生時間をLRCLIBへ送信します。同期歌詞が見つからない場合は、同じ情報を複数の公開歌詞プロバイダーを横断するlrc muxへ送信します。通常歌詞も見つからない場合は、曲名とアーティスト名をLyrics.ovhへ送信します。翻訳を有効にした場合、取得した歌詞を利用者が選択したOpenAI、Google GeminiまたはDeepLのAPIへ送信します。各サービスの規約とプライバシーポリシーも適用されます。\n\n"
                + "APIキーと保存データ\n"
